...
class ViewSettings:
    ...
    TITLE_LABEL_POSITION = (X_SECOND - TITLE_LABEL_DIMENSION[0] // 2, 25)

    BUTTON_BACK_DIMENSION = (125, 35)
    BUTTON_BACK_POSITION = (50, HEIGHT - 100)

    PRETRAINED_BUTTON_DIMENSIONS = (250, 35)
    PRETRAINED_BUTTON_POSITION = (X_SECOND - PRETRAINED_BUTTON_DIMENSIONS[0] // 2 - 200, Y_SECOND - PRETRAINED_BUTTON_DIMENSIONS[1] // 2 - 100)

    OPTIONS_BUTTON_DIMENSIONS = (250, 35)
    OPTIONS_BUTTON_POSITION = (X_SECOND - OPTIONS_BUTTON_DIMENSIONS[0] // 2 + 200, Y_SECOND - OPTIONS_BUTTON_DIMENSIONS[1] // 2 - 100)
