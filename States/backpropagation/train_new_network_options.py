...
class BackpropagationTrainNewNetworkOptions(BaseState):
    def __init__(self, state_manager: StateManager, ui_manager: UIManager):
        ...
        self.starting_snake_size_label = None
    ...
    def start(self):
        ...
        self.file_name_entry = UITextEntryLine(pygame.Rect((410, 350), (125, 30)), self.ui_manager)
        self.file_name_label = UILabel(pygame.Rect((405, 300), (125, 35)), "Network name", self.ui_manager)
    ...
    def end(self):
        ...
        self.starting_snake_size_label.kill()
